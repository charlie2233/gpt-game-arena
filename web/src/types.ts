...
export type ToolInput = { create_game: { game: "chess" | "go"; playerColor: Color; boardSize?: GoBoardSize }; get_game_state: { gameId: string }; play_game_move: { gameId: string; actor: "player" | "gpt"; move: string; expectedVersion: number }; reset_game: { gameId: string }; render_game: { gameId: string } };
