...
export type ToolInput = {
  create_game: { game: "chess"; playerColor: Color; difficulty: GameDifficulty; boardSize?: never } | { game: "go"; playerColor: Color; difficulty: GameDifficulty; boardSize?: GoBoardSize } | { game: "tic-tac-toe" | "connect-four" | "reversi"; playerColor: Color; difficulty: GameDifficulty; boardSize?: never };
