...
export type TicTacToeSnapshot = BaseSnapshot & { kind: "tic-tac-toe"; board: Board<3, 3>; legalMoves: TicTacToeCoordinate[]; winningLine?: [TicTacToeCoordinate, TicTacToeCoordinate, TicTacToeCoordinate] };
export type ConnectFourSnapshot = BaseSnapshot & { kind: "connect-four"; board: Board<6, 7>; legalMoves: ConnectFourColumn[]; winningLine?: [ConnectFourCoordinate, ConnectFourCoordinate, ConnectFourCoordinate, ConnectFourCoordinate] };
