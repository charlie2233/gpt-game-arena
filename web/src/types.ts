...
export type BaseSnapshot = { gameId: string; resetEpoch?: number; difficulty: GameDifficulty; playerColor: Color; turn: Color; status: "active" | "finished"; winner?: Color | "draw"; legalMoves: string[]; moveHistory: MoveRecord[]; lastMove?: MoveRecord; stateVersion: number; message: string };
