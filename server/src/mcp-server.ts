...
export function createMcpServer(service: ToolService, options: McpServerOptions = {}): McpServer {
  ...
  registerTool(server, service, "create_game", "Create game", "Use this when starting chess or Go. Set difficulty to easy, medium, or hard; an omitted difficulty defaults to medium. For Go, set boardSize to 9, 13, or 19; an omitted boardSize defaults to 9.", {
